...
/*
 * This program uses various test cases to check that the solve method in MazeSolver.java
 * is working as expected. It has helper methods to format and compare mazes.
 */
...
public class TestSolvers {
	...
	@Test
	public void testBasicMazeWithWalls() {
		String[] mazeString = new String[] { 
				"___S", 
				"_##_", 
				"__#_", 
